...
layout: page
order: 13
title: "Week 7 Exercise: JavaScript and Tests"
---
...
We have a set of code templates to work from this week. Download [the starting source code for this week](https://martinjc.github.io/introduction-to-js/examples/week7-javascript-programming.zip) and extract it.
...
-   There is a `.gitignore` file. This tells Git to ignore certain files and folders and not to include them in the repository.
...
![Failing Test]({{ "/img/test-hello-fail.png" | url }})
